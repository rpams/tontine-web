...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-20 xl:px-32">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Tontine</h1>
                <p className="text-xs text-gray-500">Épargne collaborative</p>
              </div>
            </div>
      ...
      {/* Hero Section */}
      <main className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-20 xl:px-32 py-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          {/* Left Section */}
          <div className="space-y-6 relative">
            <div className="space-y-4 relative z-10">
              <div className="inline-flex items-center px-3 py-1.5 bg-green-50 rounded-full text-sm font-medium text-green-800 border border-green-200">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a 
                href="/register"
                className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors shadow-sm text-center"
              >
                Démarrer mon épargne
              </a>
              <a 
                href="/tontines"
                className="bg-white border border-gray-300 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 hover:border-gray-400 transition-colors text-center"
              >
          ...
          <div className="lg:pl-4 relative">
            {/* Featured Success Woman Image */}
            <div className="absolute -top-28 -right-20 w-72 h-96 lg:block hidden z-20">
            ...
            <div className="bg-white rounded-xl shadow-lg p-5 py-3 max-w-sm mx-auto -mt-10 relative z-10">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="font-bold text-gray-900">Mes Tontines</h3>
                  <p className="text-gray-600 text-sm">3 tontines actives</p>
                </div>
        ...
        {/* Floating Cards Outside Presentation Section */}
      ...
      <footer className="bg-white/95 backdrop-blur-sm border-t border-gray-200 mt-12 relative z-10">
        <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-20 xl:px-32 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-4">
              <img src="/images/mtn.png" alt="MTN" className="h-5 w-auto opacity-60 hover:opacity-100 transition-opacity" />
              <img src="/images/moovmoney.png" alt="Moov" className="h-5 w-auto opacity-60 hover:opacity-100 transition-opacity" />
              <img src="/images/visa.svg" alt="Visa" className="h-5 w-auto opacity-60 hover:opacity-100 transition-opacity" />
              <img src="/images/mastercard.svg" alt="MC" className="h-5 w-auto opacity-60 hover:opacity-100 transition-opacity" />
            </div>
          </div>
        </div>
      </footer>
