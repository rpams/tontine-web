  ...
  const handleAvatarUpload = (file: File) => {
    if (file && file.type.startsWith('image/')) {
      ...
      reader.onload = (e) => {
        ...
        if (result) {
          setSelectedAvatar(result); // Utilise le data URL pour la prévisualisation
        }
      };
        ...
        <DialogContent className="mx-auto sm:max-w-md max-w-[92vw] max-h-[85vh] sm:h-auto overflow-y-auto p-0">
          ...
          <div className="space-y-3 sm:space-y-4 px-2.5 sm:px-6">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-2 sm:p-4 text-center hover:border-gray-400 transition-colors">
                <div className="space-y-1 sm:space-y-2">
                  <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gray-100 rounded-full flex items-center justify-center mx-auto">
          ...
          <DialogFooter className="gap-2 flex-col sm:flex-row px-2 sm:px-6 pb-3 sm:pb-4">
